...
\begin{minipage}{0.69\linewidth}
  \begin{Def}
    设$A,B$是任意的两个集合，至少属于集合 $A$ 与集合$B$之一的那些元素构成的集合称为 $A$ 与 $B$ 的\alert{并集}，记为$A \cup B$。
    \begin{equation*}
...
\begin{minipage}{0.69\linewidth}
  \begin{Def}
    设$A,B$是任意的两个集合，由既属于集合 $A$ 与又属于集合 $B$ 的所有元素构成的集合称为 $A$ 与 $B$ 的\alert{交集}，记为$A \cap B$。
    \begin{equation*}
...
\begin{minipage}{0.69\linewidth}
  \begin{Def}
    设$A,B$是任意的两个集合，由属于集合$A$但不属于集合$B$的所有元素构成的集合称为 $A$ 与 $B$ 的\alert{差集}，记为$A \setminus B$。
    \begin{equation*}
