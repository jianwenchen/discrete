...
\begin{frame}
  \frametitle{2. 关系的性质}
  \begin{Def}
    集合$X$上的二元关系称为\alert{对称}的，如果对$X$的任意元素$x$，$y$，只要$xRy$就有$yRx$。
  \end{Def}
\end{frame}
\begin{frame}
  \frametitle{2. 关系的性质}
  \begin{Def}
         集合$X$上的二元关系称为\alert{反对称}的，如果对$X$的任意元素$x$，$y$，$xRy$且$yRx$，则$x=y$。    
  \end{Def}
\end{frame}
\begin{frame}
  \frametitle{2. 关系的性质}
  \begin{Def}
        集合$X$上的二元关系称为\alert{传递}的，如果对$X$的任意元素$x$，$y$，$z$，只要$xRy$且$yRz$，就有$xRz$。
  \end{Def}
\end{frame}
\section{关系的运算}
\begin{frame}
...
\begin{frame}
  ...
  \end{Def}\pause
    \begin{Thm}
    设$R_1$，$R_2$，$R_3$分别为从集合$A$到集合$B$，从集合$B$到集合$C$，从集合$C$
    到集合$D$的二元关系，则
...
\begin{frame}
  ...
  \begin{Def}
    ...
    \cdots, y_n\}$为一个包含$n$个元素的集合。令$R$是$X$到$Y$的一个二元关系。
...
\begin{frame}
  ...
  \item $R$是传递的，当且仅当从该顶点沿矢线经两条矢线可到另一顶点，则从该顶点到
    另一顶点有一条矢线。
  \end{enumerate}
\end{Thm}
\end{frame}
...
\begin{frame}
  \frametitle{5. 关系的闭包}
  \begin{Def}
    设$R$是集合$X$上的一个二元关系。$X$上的一切包含$R$的传递关系的交称为$R$的传递闭包，用$R^+$表示。即
    \begin{equation*}
...
\begin{frame}
  \frametitle{5. 关系的闭包}
  \begin{Thm}
    设$R$为集合$X$上的二元关系，$a \in X$，$b \in X$，$n \geq 2$，则$(a,b) \in R^n$当且仅当存在$x_1\in X$，$x_2\in X$，$\ldots$，$x_{n-1}\in X$，使得$(a, x_1) \in R$，$(x_1, x_2)\in R$，  $\ldots$， $(x_{n-1}, b)\in R$。
  \end{Thm}
  \begin{proof}[证明]
...
\begin{frame}
  ...
  \pause
  \begin{Thm}
    设$R$为集合$X$上的二元关系，$|X| = n$， $B$为$R$的关系矩阵，$B_{R^+}$为$R^+$的关系矩阵，简记为$B^+$，则
    \begin{equation*}
